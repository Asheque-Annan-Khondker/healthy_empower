...
app.put('/api/users/:userId/goals/:goalId', (req, res) => {
  try {
    const userId = req.params.userId;
    const goalId = req.params.goalId;
    const goalData = req.body;
...
app.delete('/api/users/:userId/goals/:goalId', (req,res) => { 
  try {
    const userId = req.params.userId;
    const goalId = req.params.goalId; 
    ...
    const userGoals = goals.get(userId); 
    const goalIndex = userGoal.findIndex(goal => goal.id === goalId);
